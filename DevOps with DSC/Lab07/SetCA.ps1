                ...
                Copy-Item C:\Windows\System32\CertSrv\CertEnroll\*.crt C:\CDP\$using:CAName.crt -Force
                Get-CAAuthorityInformationAccess | Remove-CAAuthorityInformationAccess -Force
                Get-CACrlDistributionPoint | Remove-CACrlDistributionPoint -Force
                Add-CAAuthorityInformationAccess -Uri http://$using:CDPURL/$using:CAName.crt -AddToCertificateAia -Force
